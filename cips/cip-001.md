...
* **Standards Track CIP** describes any change that affects
  ...
  * **CRC(Celestia Request for Comment)**: Rollup standards and conventions, including standards
...
For example, you would link to this CIP as `./cip-001.md`.
...
* Callum Waters ([@cmwaters](https://github.com/cmwaters))

Emeritus EIP editors are

* Yaz Khoury ([@YazzyYaz](https://github.com/YazzyYaz))

If you would like to become a CIP editor, please check [CIP-2](./cip-002.md).
