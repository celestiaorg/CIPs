...
Prover programs can be written by networks using popular ZKVMs like SP1 and Risc0. This allows networks to upgrade to a secure, proof-based path to transfer assets via Celestia if they wish to.
