...
**From**: A uint16 representing the first index of the sampled share within the ODS. The 16 bit
limit fits data squares up to 2TB. It MUST stay within the number of original shares(1st quadrant) of the EDS.

**To**: A uint16 representing the last index of the sampled share within the ODS(exclusively). The 16 bit
limit fits data squares up to 2TB. It MUST stay within the number of original shares(1st quadrant) increased by one of the EDS.
