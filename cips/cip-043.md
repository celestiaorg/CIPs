...
The fee address provides rollups a simple way to contribute fees to Celestia. By converting fee address funds into real transaction fees, contributions appear in dashboard revenue calculations (e.g., Blockworks, Celenium).
...
The message has no signer - it is validated by checking the proposer matches the block proposer. The proposer field prevents replay attacks by ensuring the tx was created for this specific block.
