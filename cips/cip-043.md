...
This is a vanity address derived from 20 zero bytes, making it easy to recognize (32 `q` characters). The address has no known private key, ensuring tokens sent there are irrecoverable.
...
```shell
# Bank send
celestia-appd tx bank send <from-key> celestia1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzf30as 1000000utia

# IBC transfer
celestia-appd tx ibc-transfer transfer <channel> celestia1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzf30as 1000000utia --from <key>
```
...
4. **Discoverability**: The vanity address (32 `q` characters) is easy to recognize and verify
