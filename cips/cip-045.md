...
message Params {
  string min_forward_amount = 1;  // Minimum amount required to forward (0 = no minimum)
}
```
...
- Integration tests: [celestia-app#6419](https://github.com/celestiaorg/celestia-app/pull/6419)
- Address derivation tests: [x/forwarding/types/address_test.go](https://github.com/celestiaorg/celestia-app/pull/6417)
